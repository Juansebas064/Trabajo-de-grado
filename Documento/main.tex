...
\pagebreak
\renewcommand\contentsname{\centering Lista de tablas}
\listoftables

\pagebreak
\renewcommand\contentsname{\centering Lista de figuras}
\listoffigures
...
\include{Anteproyecto/1FormulacionDelProblema}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Marco Referencial %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Anteproyecto/2MarcoReferencial}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Alcance %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{Anteproyecto/3Alcance}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Objetivos %%%%%%%%%%%%%%%%%%%%%%%%%
\input{Anteproyecto/4Objetivos}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Metodología %%%%%%%%%%%%%%%%%%%%%%%%%
\input{Metodologia/5Metodologia.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Arquitectura y diseño %%%%%%%%%%%%%%%%%%%%%%%%%
\input{ArquitecturaYDiseno/6ArquitecturaYDiseno.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Desarrollo %%%%%%%%%%%%%%%%%%%%%%%%%
\input{Desarrollo/7Desarrollo.tex}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Desarrollo %%%%%%%%%%%%%%%%%%%%%%%%%
\input{Pruebas/8Pruebas.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Conclusiones %%%%%%%%%%%%%%%%%%%%%%%%%
\input{ConclusionesYTrabajosFuturos/Conclusiones.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Trabajos futuros %%%%%%%%%%%%%%%%%%%%%%%%%
\input{ConclusionesYTrabajosFuturos/TrabajosFuturos.tex}
